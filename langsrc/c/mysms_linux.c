...
void AddNewStudent()
{
    ...
    while(!IsValidName)
    {
        ...
        // scanf("%[^\n]s",Name);  //scanf(" %[^\n]s",&Name);
        // scanf(" %[^\n]",Name); 
        // scanf("%[^\n ]",Name); // not work, auto input latest value
