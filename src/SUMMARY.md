...
- [技术沉思录](designs/readme.md)
	- [sqlite](designs/sqlite/sqlite.md)
		- [sqlite随机查询](designs/sqlite/sqlite随机查询.md)
	- [python](designs/python/python.md)
		- [uv](designs/python/uv.md)
		- [异步上下文生成器](designs/python/异步上下文生成器.md)
	- [分布式缓存设计](designs/分布式缓存设计.md)
	- [authentication](designs/authentication.md)
	- [authorization](designs/authorization.md)
	-  [决策引擎设计](designs/决策引擎/readme.md)
		- [zen-engine](designs/决策引擎/zen-engine.md)
		- [zen-expression](designs/决策引擎/zen-expression.md)
		- [dmn](designs/决策引擎/dmn.md)
		- [CEP](designs/决策引擎/CEP.md)