...
### [](https://diveintosystems.org/book/C2-C_depth/arrays.html#_single_dimensional_arrays)2.5.1. 一维数组(Single-Dimensional Arrays)

#### [](https://diveintosystems.org/book/C2-C_depth/arrays.html#_statically_allocated)静态分配(Statically Allocated)
...
#### [](https://diveintosystems.org/book/C2-C_depth/arrays.html#_dynamically_allocated)动态分配(Dynamically Allocated)
...
#### [](https://diveintosystems.org/book/C2-C_depth/arrays.html#_array_memory_layout)数组内存布局(Array Memory Layout)
...
### [](https://diveintosystems.org/book/C2-C_depth/arrays.html#_two_dimensional_arrays)2.5.2. 二维数组(Two-Dimensional Arrays)
...
#### [](https://diveintosystems.org/book/C2-C_depth/arrays.html#_statically_allocated_2d_arrays)静态分配的二维数组(Statically Allocated 2D Arrays)
...
#### [](https://diveintosystems.org/book/C2-C_depth/arrays.html#_two_dimensional_array_parameters)二维数组参数(Two-Dimensional Array Parameters)
...
#### [](https://diveintosystems.org/book/C2-C_depth/arrays.html#_two_dimensional_array_memory_layout)二维数组内存布局(Two-Dimensional Array Memory Layout)
...
#### [](https://diveintosystems.org/book/C2-C_depth/arrays.html#_dynamically_allocated_2d_arrays)动态分配的二维数组(Dynamically Allocated 2D Arrays)
...
#### [](https://diveintosystems.org/book/C2-C_depth/arrays.html#_method_1_memory_efficient_allocation)方法1:内存高效分配(Method 1: Memory-Efficient Allocation)
...
##### [](https://diveintosystems.org/book/C2-C_depth/arrays.html#_method_1_single_malloc_and_function_parameters) 单个malloc和函数参数(Method 1 (Single malloc) and Function Parameters)
...
#### [](https://diveintosystems.org/book/C2-C_depth/arrays.html#_method_2_the_programmer_friendly_way)程序员友好的方法(Method 2: The Programmer-Friendly Way)
...
##### [](https://diveintosystems.org/book/C2-C_depth/arrays.html#_method_2_an_array_of_arrays_and_function_parameters)方法2 数组的数组和函数参数(Method 2 (An Array of Arrays) and Function Parameters)
