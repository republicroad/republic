...
curl "http://150.158.144.155:8888/group_agg_1m?group_key=deviced1&agg_key=fccd1"
...

curl "http://150.158.144.155:8888/group_agg_1m?group_key=deviced1&agg_key=fccd2"
...

curl "http://150.158.144.155:8888/group_agg_1m?group_key=deviced1&agg_key=fccd3"
...

curl "http://150.158.144.155:8888/group_agg_1m?group_key=deviced1&agg_key=fccd4"
...

curl "http://150.158.144.155:8888/group_agg_1m?group_key=deviced1&agg_key=fccd5"
...
```
...
```bash
watch -n 1 'echo "show table group_agg_1m" | sudo socat unix:/run/haproxy/admin.sock -'

Every 1.0s: echo "show table group_agg_1m" | sudo socat unix:/run/haproxy/admin.sock -                                                                                                              VM-16-16-ubuntu: Mon May 20 23:21:03 2024

# table: group_agg_1m, type: string, size:1048576, used:6
...
```bash
wrk -t12 -c400 -d30s --latency "http://10.0.16.16:8888/group_agg_1m?group_key=deviced1&agg_key=fccd5"
```